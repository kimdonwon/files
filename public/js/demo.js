(function() {
    ...
    function initEvents() {
        ...
        document.querySelector('.pieces-slider__canvas').addEventListener('click', function(){
          if(page==1)location.href='/profile';
          else if(page==2)location.href='http://www.google.com';
        });
